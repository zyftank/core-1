...
#       if defined(G3D_WIN32) && defined(_MSC_VER)

            return InterlockedExchangeAdd(&m_value, x);

#       elif defined(__MINGW32__) || defined(G3D_LINUX) || defined(G3D_FREEBSD)
...
#       elif defined(__MINGW32__) || defined(G3D_LINUX) || defined(G3D_FREEBSD) || defined(G3D_OSX)
